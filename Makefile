...
build: lib/biwascheme.js lib/console_biwascheme.js bin/biwas lib/biwa.node.js
...
lib/biwa.node.js: src/server/node_module_preamble.js lib/console_biwascheme.js src/server/node_module_postamble.js

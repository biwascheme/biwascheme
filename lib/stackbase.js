...
//  }
  ...
  TopEnv["define"] = new Syntax(function(x) {return x;});
  TopEnv["begin"]  = new Syntax(function(x) {return x;});
  TopEnv["quote"]  = new Syntax(function(x) {return x;});
  TopEnv["lambda"] = new Syntax(function(x) {return x;});
  TopEnv["if"]     = new Syntax(function(x) {return x;});
  TopEnv["set!"]   = new Syntax(function(x) {return x;});

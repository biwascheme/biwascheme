...
//  }
  ...
  BiwaScheme.Syntax = Class.create({
    ...
    transform: function(x){
      if (!this.func){
        throw new Bug("syntax "+this.sname+" is a pseudo syntax now");
      }
      return this.func(x);
    },
    to_write: function(){
  ...
  TopEnv["define"] = new Syntax();
  TopEnv["begin"]  = new Syntax();
  TopEnv["quote"]  = new Syntax();
  TopEnv["lambda"] = new Syntax();
  TopEnv["if"]     = new Syntax();
  TopEnv["set!"]   = new Syntax();
